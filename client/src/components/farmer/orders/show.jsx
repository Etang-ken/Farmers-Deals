      ...
      <div className="buyer-section pt-0 mt-0">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 px-4 border-left-bottom-right rounded-b-lg bg-slate-100">
          ...
          <div className="flex gap-2">
            <CalendarFilled />
            <div>
              <p className="text-slate-600 text-xs mb-1">Latest Date Needed</p>
        ...
        <h3 className="heading-3 mb-1">Buyer Information</h3>
        <ShortBottomLine />
        ...
        <div className="flex flex-wrap gap-4">
          <div>
            <Link className="primary-button">
              <CheckCircleFilled className="pr-2" /> Accept Order
            </Link>
          </div>
