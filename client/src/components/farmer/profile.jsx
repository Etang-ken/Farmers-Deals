  ...
  return (
    <div className="profile">
      <Dashboard title="Profile">
        ...
        <div className="profile-head  !border-t-0 bg-slate-100 !mb-12">
        ...
        {/* personal info  */}
        <div className="profile-body bg-slate-50 my-5">
          <div className="flex">
        ...
        <div className="profile-body bg-slate-50 my-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-3">
            ...
            <div>
              <p className="text-slate-600 text-xs mb-1">Years of Farming Experience</p>
              <p>7</p>
            </div>
          </div>
          <div className="mt-8 flex md:hidden">
