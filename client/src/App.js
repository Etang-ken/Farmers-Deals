      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route exact path="/farmer-products" element={<FarmerProducts />} />
              <Route exact path="/farmer-products/create" element={<FarmerCreateProduct />} />
              <Route exact path="/farmer-products/:id/show" element={<FarmerShowProduct />} />
              <Route exact path="/farmer-products/:id/edit" element={<FarmerEditProduct />} />
          <Route exact path="/farmer-deals" element={<FarmerDeals />} />
          <Route exact path="/farmer-orders" element={<FarmerOrders />} />
              <Route exact path="/farmer-orders/:id/show" element={<FarmerShowOrder />} />
          ...
          <Route exact path="/buyer-products" element={<BuyerProducts />} />
              <Route exact path="/buyer-products/:id/show" element={<BuyerShowProduct />} />
          <Route exact path="/buyer-deals" element={<BuyerDeals />} />
          <Route exact path="/buyer-orders" element={<BuyerOrders />} />
              <Route exact path="/buyer-orders/create" element={<BuyerCreateOrder />} />
              <Route exact path="/buyer-orders/:id/edit" element={<BuyerEditOrder />} />
              <Route exact path="/buyer-orders/:id/show" element={<BuyerShowOrder />} />
